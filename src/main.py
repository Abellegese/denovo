...
,
  ...
  state = orbax_checkpointer.restore('/home/abellegese/Videos/pipeline/tests/')
  # print(state)
  ...
  p = state['model']['params']
  # Initialize the model with loaded parameters
  z, c = model.apply({'params': p}, spectra, precursor, spectr_mask, method=model.get_latent_representations)
...
reshaped_embeddings = z.reshape((-1, 512))
